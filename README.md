...
**v1.6.1** — Premium badge cleanup. The embedded crown/lock badge icons (base64 SVG images rendered on premium thumbnails) are now removed from the DOM along with any empty wrapper left behind.
